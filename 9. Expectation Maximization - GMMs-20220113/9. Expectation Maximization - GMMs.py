...
gdata = pd.read_csv("C:/Users/John/Documents/Google Drive/Pattern-Recognision/9. Expectation Maximization - GMMs-20220113/gdata.txt")
x = gdata.loc[:, "X"]
y = gdata.loc[:, "Y"]
...
# gsdata = pd.read_csv("C:/Users/John/Documents/Google Drive/Pattern-Recognision/9. Expectation Maximization - GMMs-20220113/gsdata.txt")
# target = gsdata.loc[:, "Y"]
...
# icdata = pd.read_csv("C:/Users/John/Documents/Google Drive/Pattern-Recognision/9. Expectation Maximization - GMMs-20220113/icdata.txt")
# x = icdata.loc[:, "X"]
# y = icdata.loc[:, "Y"]
# data = np.array(x.tolist()).reshape(-1,1)
